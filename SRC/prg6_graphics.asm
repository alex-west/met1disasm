...
.include common_chr/samus.asm

; Item Graphics (plus bomb, the N in "EN", and another dot thingy)
.include common_chr/items.asm

;Intro and end tile patterns.
.include common_chr/intro_sprites.asm
...
.include common_chr/title.asm

;Suitless Samus tile patterns.
.include common_chr/samus_suitless.asm
